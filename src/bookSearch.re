let bookResultItem (book:Database.book) =>  <a key=(string_of_int book.id) href=("#/detail/" ^ string_of_int book.id) className="navbar-item">
    ...
    */
    <div className="replace this by the above comment logic">
      ...
      <div className="navbar-dropdown">
        ...
        */
        <a className="navbar-item">(Utils.ste "BOOK")</a>
      </div>
    </div>
  }
};